...
namespace day6webapi.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Orderst>>> GetAllOrdersByCreatedDate(DateTime dt)
        {
            try
            {
                ...
                var resp = await _orderBusiness.GetAllOrdersByCreatedDate(dt);
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [Produces("application/json", Type = typeof(IEnumerable<Orderst>))]
        [Route("get-all-user-names")]
        public async Task<ActionResult<int>> GetAllUserNames()
        {
            try
            {
